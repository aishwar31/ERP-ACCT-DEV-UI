...
export class AccJournalComponent implements OnInit {
  ...
  constructor(private userAddService:UserAddService,private billService: BillService, 
    public mainService: MainService, private ledgerService: LedgerService, private router: Router, 
