...
@Component({
  selector: 'app-department-demands',
  templateUrl: './department-demands.component.html',
  styleUrls: ['./department-demands.component.css']
})
export class DepartmentDemandsComponent implements OnInit {
  dataSource: any[];
  allEventLayouts: any;
  fieldTechnicalNames = {};
  fieldBusinessNames = {};
