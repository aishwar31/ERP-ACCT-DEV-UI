...
export class PayrollService {
  ...
  async getleafvalue(obj)
  {
    console.log(obj)
    const resp = await this.http.get<any>(this.httpUrl + '/payroll_info/bill/getleafvalue' + obj).toPromise().then(res => {
      return res;
    });
    return resp;
  }
...
async getPersonalInfo(obj){
 ...
 async updatesalary(obj) {
  ...
  // }
  async getEmployeeMasterData(obj) {
    const resp = await this.http.get<any>(this.httpUrl + '/emp_info/empInfo/getAllListOfEmployeeestablish' + JSON.stringify(obj)).toPromise().then(res => {
      return res;
    });
    return resp;
  }
  ...
  async getNewEffectiveFixedPay(obj) {
  ...
  async insertAttendenceSheet(obj) {
  ...
  async getSection(obj)
  {
    const resp = await this.http.post<any>(this.httpUrl + '/payroll_info/bill/getSection', obj).toPromise().then(res => {
      return res;
    });
    return resp;
  }
  ...
  async getcumulative(obj) {
    const resp = await this.http.get<any>(this.httpUrl + '/payroll_info/bill/getCumulativeAmount' + obj).toPromise().then(res => {
      return res;
    });
    return resp;
  }
